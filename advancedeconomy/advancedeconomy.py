...
class AdvancedEconomy(commands.Cog):
    ...
    async def economy_highest_job_amount(
        self, ctx: commands.Context, amount: PositiveInt
    ):
        ...
        **Arguments**
        ...
        await ctx.send(
            f"Done. The highest amount a job will pay someone is now set to {amount} {currency_name}"
        )
